...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('caracteristicas_personales', function (Blueprint $table) {
            $table->integer('id_caracteristica_personal')->primary()->unsigned()->autoIncrement();
            ...
            $table->foreign('id_ficha')->references('id_ficha')->on('ficha_identificacion_tutorado')->onDelete('cascade');
        });
    }
